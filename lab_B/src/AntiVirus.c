...
struct fun_desc menu[] = { { "Load signatures", LoadSignatures }, { "Print signatures", PrintSignatures }, { "Detect Viruses", detect_virus }, {"Fix file", stub}, {"AI analysis of file", stub}, {"Quit", Quit}, {NULL, NULL} };
